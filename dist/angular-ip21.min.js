...
function ip21SqlService($http, $q) {
    ...
    function create(serverConfig) {
        if (serverConfig == undefined) throw new TypeError('create expects a server configuration object as argument.');
        ...
        function execute(query, isSelect) {
            ...
            if (!serverConfig) throw "InfoPlus.21 configuration is undefined. Use setConfig.";

            var s = isSelect ? 1 : 0;
            var payload = '<SQL c="DRIVER={AspenTech SQLplus};' + 'HOST=' + serverConfig.host + ';' + 'Port=' + serverConfig.port + ';' + serverConfig.adsa + '" s="' + s + '">' + '<![CDATA[' + query + ']]>' + '</SQL>';
